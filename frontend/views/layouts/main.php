        ...
        <div id="top-menu">
            <div id="top-menu_1">
                ...
                <hgroup class="logo-site" style="margin-top: 10px;">
                    <h1 class="site-title"><a href="/" title="听云台" rel="home">听云台</a></h1>
                    <p class="site-description">崇尚完美 追求极致</p>
...
<footer class="footer">
    <div class="footer-inner">
        <p>
            <a href="<?= Yii::$app->feehi->website_url ?>" title="<?= Yii::$app->feehi->website_title ?>"><?= Yii::$app->feehi->website_title ?></a> <?= Yii::t('frontend', 'Copyright, all rights reserved') ?> © 2015-<?=date('Y')?>&nbsp;&nbsp;<a href="<?=Url::to(['sitemap/view'])?>">站点地图</a>
        ...
        <p><?=Yii::$app->feehi->website_icp?> Powered by <?= Yii::$app->feehi->website_title ?> </p>
    </div>
</footer>
