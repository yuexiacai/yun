...
$this->title = '站点地图' . '-' . Yii::$app->feehi->website_title;

$this->registerMetaTag(['name' => 'keywords', 'content' => '站点地图,sitemap'], 'keywords');
$this->registerMetaTag(['name' => 'description', 'content' => '站点地图,sitemap'], 'description');
?>
