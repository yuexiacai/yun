...
<aside class="sidebar">
    ...
    <div class="widget d_textbanner">
        <a class="style03" target="_blank"
           href="//shang.qq.com/wpa/qunwpa?idkey=dfadbc9eb6e791608e7440a2aa73360e2451943f32152ece078147e2f1801978">
            <strong><?=Yii::t('frontend', 'Join group')?></strong>
            <h2><?=Yii::t('frontend', 'Official QQ group - main')?></h2>
            <p><?=Yii::t('frontend', 'official QQ group number: {number}', ['number'=>'179214953'])?>
                <br>
                <br>
                <img border="0" src="<?=Yii::$app->getRequest()->getBaseUrl()?>/static/images/group.png" alt="万达q群" title="万达q群">
            </p>
        </a>
    </div>
