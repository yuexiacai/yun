...
$categoryId = $model->category ? $model->category->id : Yii::t('app', 'uncategoried');
...
<div class="content-wrap">
    <div class="content">
        ...
        echo Breadcrumbs::widget([
            'catid'=>$categoryId,
            'current_text'=>$model->title,
            'tag'=>'div',
            // 'homeLink'=>[
            //    'label'=>'后台首页>>', 修改默认的Home
            //    'url'=>Url::to(['index/index']), 修改默认的Home指向的url地址
            // ],
            'homeLink' => ['label' => '', 'url' => Yii::$app->getHomeUrl()],
            //'homeLink'=>false, // 若设置false 则 可以隐藏Home按钮
            'itemTemplate'=>"<span >{link}</span><small>&gt;</small>",
...
/*            'links' => [
        ...
        <article class="article-content">
            ...
            <p >
                ...
                $tagsModels = $model->articleTags;
                $tags = '';
                foreach ($tagsModels as $tag) {
                    $tags .= " <a title='' href='" . Url::to(['search/tag', 'tag' => $tag->value]) . "'>$tag->value</a> ";
                }
