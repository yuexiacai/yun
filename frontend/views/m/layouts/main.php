...
<footer class="footer">
    <div class="footer-inner">
        <p>
            <a href="<?= Yii::$app->feehi->website_url ?>" title="<?= Yii::$app->feehi->website_title ?>"><?= Yii::$app->feehi->website_title ?></a> <?= Yii::t('frontend', 'Copyright, all rights reserved') ?> © 2015-<?=date('Y')?>&nbsp;&nbsp;
