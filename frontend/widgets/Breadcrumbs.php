...
class Breadcrumbs extends Widget
{
    ...
    public function run()
    {
        ...
        if ($this->homeLink === null) {
            ...
            //$itemTemplate1 = '<a href="/" ><i class="fa fa-home"></i></a><small>&gt;</small>';
            $itemTemplate1 = '<a href="/" ><i class="fa fa-home"></i></a><small>&gt;</small>';
            $links[] = $this->renderItem($this->homeLink, $itemTemplate1);
        }
        //如果前端没传links内容，则自动获取分类
        if (empty($this->links)) {
            $arrlinks = Category::getCatgoryLinks($this->catid);
            ...
            foreach ($arrlinks as $link){
                $arr[] = [
                    ...
                    //['post-category/view', 'id' => 10, 'name' => 'bing'],
                ];
            }
            $this->links = $arr;
        }
        ...
        $links[]='<span class="muted">'.$this->current_text.'</span>';

        $str = Html::tag($this->tag, implode('', $links), $this->options);
        echo $str;
    }
