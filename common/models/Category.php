...
class Category extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'seo_title','seo_keywords','seo_description','alias', 'remark'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name' => Yii::t('app', 'Name'),
            'seo_title' => Yii::t('app', 'seo_title'),
            'seo_keywords' => Yii::t('app', 'seo_keywords'),
            'seo_description' => Yii::t('app', 'seo_description'),
